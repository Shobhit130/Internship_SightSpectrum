...
// 	users = []User{
// 		{ID: 1, Username: "user1", Password: hashPassword("password1"), Email: "abc@gmail.com"},
// 		{ID: 2, Username: "user2", Password: hashPassword("password2"), Email: "xyz@gmail.com"},
// 	}
...
// 	// Update the fields of the product directly in the products slice
// 	products[productIndex].Name = c.PostForm("name")
// 	products[productIndex].Description = c.PostForm("description")
// 	products[productIndex].Price, _ = strconv.ParseFloat(c.PostForm("price"), 64)
// 	products[productIndex].Inventory, _ = strconv.Atoi(c.PostForm("inventory"))
